...
for p in range(100):
    ...
    universe.addParticles(mass=particle_mass, size=particle_size, speed=0, colour=(0,0,255))

def main():
    running = True

    pygame.display.set_caption("Cantidad de movimiento")
    fondo=cargar_imagen("images/fondoGravedad.jpg")
    ...
    while running:
        ...
        datosParticula = "Posicion (x, y): (%4f,%4f) m  Velocidad: %3f m/s Angulo: %f m" %(2,
                3, 3.4,2.3)
